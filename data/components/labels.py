...
class MultiLineLabel(pg.sprite.Sprite):
    ...
    def __init__(self, path, size, text, color, rect_attr, bg=(0, 0, 0),
        ...
        labels = [Label(line, attr, text_color=_parse_color(color),
                     fill_color=_parse_color(bg), font_path=path,
                     font_size=size) for line in lines]
